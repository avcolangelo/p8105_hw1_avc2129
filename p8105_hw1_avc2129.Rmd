...
set.seed(3)
  ...
  problem2_df = tibble(
    ...
    ```
#### Description: The number of observations in this data frame is `r nrow(problem2_df)`and the number of variables is `r ncol(problem2_df)`. The mean of x is `r mean(pull(problem2_df, x))`, the median of x is `r median(pull(problem2_df, x))`, and the standard deviation of x is `r sd(pull(problem2_df, x))`.
